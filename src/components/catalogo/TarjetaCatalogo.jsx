...
>
  ...
  <div className="ratto ratto-1x1 bg-light" style={{ overflow: "hidden" }}>
  {producto.url_imagen ? (
    <img
    ...
    <div className="d-flex align-items-center justify-content-center h-160 bg-secondary-subtle">
...
<Card.Body className="d-flex flex-column p-3">
  <Card.Title id={`producto-${producto.id_producto}-title`} className="h6 fw-bold text-dark mb-2">
  ...
  <div className="mt-auto pt-2">
    <h4 className="text-success fw-bold mb-0"> C${parseFloat(producto.precio_venta).toFixed(1)} </h4>
  </div>
